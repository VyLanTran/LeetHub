<h2><a href="https://leetcode.com/problems/graph-valid-tree/?envType=problem-list-v2&envId=union-find">261. Graph Valid Tree</a></h2><h3>Medium</h3><hr><p>You have a graph of <code>n</code> nodes labeled from <code>0</code> to <code>n - 1</code>. You are given an integer n and a list of <code>edges</code> where <code>edges[i] = [a<sub>i</sub>, b<sub>i</sub>]</code> indicates that there is an undirected edge between nodes <code>a<sub>i</sub></code> and <code>b<sub>i</sub></code> in the graph.</p>
